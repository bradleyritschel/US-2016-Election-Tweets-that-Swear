...
TweetPublisher.start = function () {
    ...
    if (!stream) {
        ...
        stream = twitter.stream('statuses/filter', { locations: '-180,-90,180,90', track:'trump,clinton,stein,johnson shit,fuck,damn,bitch,crap,piss,dick,darn,cock,pussy,asshole,fag,bastard,slut,douche' });
